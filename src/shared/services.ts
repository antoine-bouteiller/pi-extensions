...
import { Ui } from '../effect/services.js'
import { type AgentActivityStore, type RunningAgent, runningAgents } from './agent_activity.js'
import { formatStatusText, publishStatus, type StatusEntry, type StatusItem, statusBar } from './status_bar.js'
 ...
 * would silently give each extension its own empty store, and the panel would render nothing.
 */
