...
const extractToolPaths = (event: ToolResultEvent, cwd: string, pathService: Path.Path): string[] => {
...
export const defaultRulesEnvironment = (): RulesEnvironment => ({ homeDirectory: homedir() })

export interface RulesHandlers {
  readonly clearInjections: (
    event: SessionStartEvent | SessionCompactEvent | SessionTreeEvent,
