...
`FeatureDescriptor` (`src/shared/effect/feature.ts`): its `activate` opens that session's child
...
| 2026-08-25 | Host session lifecycle enters through the `FeatureDescriptor` and feature coordinator instead of a self-registered session-start hook.                                                                                                                                                                                                                                                                               | 7                 | Match the package's descriptor-based feature composition landed after this spec was written.                                           |
