...
| -------- | ------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `[KD-3]` | Tool callbacks bridge inline; each drops the pre-dispatch check, the `{ signal }` option, or both                               | `src/features/ask_user/index.ts:28`, `src/features/background_poll/index.ts:14`, `src/features/safe_rm/index.ts:15`, `src/features/mcp/index.ts:21` (no pre-check), `src/features/webfetch/index.ts:12` (no `{ signal }`), `src/features/sub_agents/agents.ts:423`, `:571`, `:637`, `:683`, `:720`, `:774`, `:839` |
