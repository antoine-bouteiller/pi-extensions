...
`[KD-14a]` is enforced with this binding-aware owner matrix. Its single `ManagedRuntime.make`
construction slot matches `isRuntimeModule`; no other construction owner is allowed:
