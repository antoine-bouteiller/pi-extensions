...
| --------- | ---------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Non-goal  | `[KD-3]`   | Inline tool bridges omit the standard executor behavior.                                                                                                                | `src/features/ask_user/index.ts:36`; `src/features/background_poll/index.ts:26`; `src/features/hashline/index.ts:32`; `src/features/safety_guard/index.ts:25`; `src/features/mcp/index.ts:45`; `src/features/webfetch/fetch.ts:389`; `src/features/sub_agents/agents.ts:442,589,656,703,741,796,862`.                    |
| Non-goal  | `[KD-5]`   | Inline command bridges.                                                                                                                                                 | `src/features/prompt_rewind/index.ts:29`; `src/features/mcp/index.ts:63`; `src/features/sub_agents/agents.ts:1104,1124`.                                                                                                                                                                                                 |
| Exception | `[KD-6]`   | Verified memory-only synchronous Effect execution.                                                                                                                      | `src/features/background_poll/poll.ts:351`; `src/features/claude_code/discovery.ts:283`; `src/features/mcp/gateway.ts:444,465,527`; `src/features/rules/rules.ts:644`; `src/features/status_panel/panel.ts:70,75,90,94`; `src/features/status_panel/sidebar.ts:410,412,476,491`; `src/features/sub_agents/core.ts:2461`. |
| Non-goal  | `[KD-7]`   | Existing fork policies; `AgentManager.reconciliation` is specifically divergent because teardown only joins it, and removal requires explicit interruption before join. | `src/features/status_panel/panel.ts:135`; `src/features/status_panel/sidebar.ts:438,448`; `src/features/sub_agents/agents.ts:374`; `src/features/sub_agents/core.ts:1135,1137,1142,1483`; `src/features/sub_agents/peek.ts:287,313,430,447,851,856`.                                                                     |
...
| Non-goal  | `[KD-14a]` | Direct runtime adapters outside approved owners.                                                                                                                        | `src/features/caffeinate/keep_awake.ts:41,44,46,48,51,119`; `src/features/comment_checker/checker.ts:145`; `src/features/mcp/oauth.ts:353`; `src/features/status_panel/panel.ts:54,56,58`; `src/features/sub_agents/agents.ts:302,1038`; `src/features/sub_agents/peek.ts:439`.                                          |
| Exception | `[KD-1]`   | Sanctioned early Bun runtime.                                                                                                                                           | `src/shared/effect/bun_services.ts:13` (runtime construction); `:18` (`bunFileSystem`), `:20` (`bunPath`), and `:22` (`bunChildProcessSpawner`) service extractions (`[C-1]`).                                                                                                                                           |
