...
| Exception | `[KD-1]`   | Sanctioned early Bun runtime.                                                                                                                                           | `src/shared/effect/bun_services.ts:14` (runtime construction); `:19` (`bunFileSystem`), `:21` (`bunPath`), and `:23` (`bunChildProcessSpawner`) service extractions (`[C-1]`).                                                                                                                                                                                                                                                                                           |
